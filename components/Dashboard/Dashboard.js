...
const Dashboard = () => {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      localStorage.setItem("username",userData.data.userData.user_details.name);
      localStorage.setItem("useremail",userData.data.userData.user_details.email);
                                  ...
                                  >
                                    ...
                                    >
                                      <div className={styles.petDetailsCard}>
                                        <div
                                          className={
                                            styles.petDetailsIconHeading
                                          }
                                        >
                                          <div
                                            className={styles.petDetailsIcon}
                                          >
                                            <Image
                                              src={DogIcon}
                                              width="50"
                                          ...
                                          <div
                                            className={styles.petDetailsHeading}
                                          >
                                            <div
                                              className={styles.petDetailsName}
                                            >
                                              {data.name}
                                            </div>
                                            <div
                                              className={
                                                styles.petDetailsTypeAge
                                              }
                                            >
                                              {data.breed}
                                            </div>
